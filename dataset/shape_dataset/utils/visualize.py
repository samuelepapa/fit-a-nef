...
import dataset.shape_dataset.utils.common as common
...
def visualise_projection(self, points, world_mat, camera_mat, img, output_file="out.png"):
    ...
    plt.plot((pimg2[:, 0] + 1) * image.shape[1] / 2, (pimg2[:, 1] + 1) * image.shape[2] / 2, "x")
